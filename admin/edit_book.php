		...
		<div class="col-md-4">
			<form action="" method="post">
				<div class="form-group">
					<label>Book No:</label>
					<input type="text" name="book_no" class="form-control" required="" value="<?php echo $book_no; ?>">
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<input type="text" name="author_id" class="form-control" required="" value="<?php echo $author_id;?>">
				</div>

				<div class="form-group">
					<label>Category Id:</label>
					<input type="text" name="cat_id" class="form-control" required="" value="<?php echo $cat_id;?>">
				</div>

				<div class="form-group">
					<label>Book Price:</label>
					<input type="text" name="book_price" class="form-control" required="" value="<?php echo $book_price;?>">
				</div>
